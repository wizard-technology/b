    ...
    <div class="container">
        ...
        <div class="flex">
            ...
            <div class="banner">
                <div>
                    <p id="brand">Bizz</p>
                    <p id="Moto">is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
        ...
        <h1 style="text-align: center;margin-top: 10%;">
            ...
            style="fill: #ff414d;"
                ...
                stroke="#ff414d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-heart">
                <path
                    d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z">
                </path>
