...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Finished Order</h4>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('dashboard.order.finished')}}">Finished Order</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Finished Order table</h4>
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$value->user->u_phone}} {{$value->user->u_phone}}
                                                    </td><td>{{$value->user->u_phone}}
                                                    ...
                                                    <td>
                                                        <div class="btn-group m-b-10">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item" href="{{route('dashboard.order.change_state',['id'=>$value->c_doc_id,'type'=>'reject'])}}">Reject</a>
