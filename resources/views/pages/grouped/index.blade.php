...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Grouped</h4>
        </div>
    </div>
</div>
<div class="row">
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#cat" role="tab">All Grouped</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#create" role="tab">Create Group</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Grouped table</h4>
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$value->id}}</td>
                                                    <td>{{$value->gr_name}}</td>
                                                    <td>{{$value->gr_name_kr}}</td>
                                                    <td>{{$value->gr_name_ku}}</td>
                                                    <td>{{$value->gr_name_ar}}</td>
                                                    <td>{{$value->gr_name_pr}}</td>
                                                    <td>{{$value->subcategory->gr_name}}/{{$value->subcategory->st_name_ku}}</td>
                                                    <td>{!! $value->gr_state == 1 ?'<span
                                                        ...
                                                        <div class="btn-group m-b-10">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{route('dashboard.type.edit',$value->id)}}">{{ $value->gr_state == 1 ? 'Inactive' :'Active'}}</a>
                                                                <button class="dropdown-item" data-toggle="modal"
                                                                    data-target=".bd-example-modal-form-{{$value->id}}">Edit</button>
                                                                <div class="dropdown-divider"></div>
                                                                <form
                                                                    action="{{route('dashboard.grouped.destroy',$value->id)}}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                                ...
                                                <div class="modal fade bd-example-modal-form-{{$value->id}}"
                                                    ...
                                                    aria-hidden="true">
                                                    <form action="{{route('dashboard.grouped.update',$value->id)}}" enctype="multipart/form-data"
                                                        method="post">
                                                        @method('PUT')
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select name="subcategory" class="form-control">
                                                                                ...
                                                                                <option {{$cat->id == $value->gr_subcategory ? 'selected' : ''}} value="{{$cat->id }}">{{$cat->st_name}} / {{$cat->st_name_ku }}
                                                                                </option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            ...
                                                                            <div class="pull-right"
                                                                                ...
                                                                                style="height: 200px;width: 200px;background-image: url({{asset('storage/'.$value->gr_image) }});background-size: contain;background-repeat: no-repeat;">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="tab-pane p-3" id="create" role="tabpanel">
                        <form action="{{route('dashboard.grouped.store')}}"  enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="form-group row">
                                <div class="col-12">
